...
/* ─── CODES PROMO ─── */
const CODES_PROMO_DEFINIS = [
  {
    id: "LANCEMENT",
    code: "LANCEMENT",
    label: "Lancement CVtools",
    description: "0F — Accès gratuit total pour le lancement",
    reduction: 100,
    type: "pct",       // pct = pourcentage, fixe = montant fixe FCFA
    icone: "🚀",
    usage_max: 9999,
  },
  {
    ...
    description: "50% de réduction sur tous les documents",
    reduction: 50,
    type: "pct",
    icone: "🎄",
    usage_max: 500,
  },
  {
    ...
    description: "CV gratuit pour les étudiants",
    reduction: 100,
    type: "pct",
    icone: "🎓",
    usage_max: 9999,
  },
  {
    ...
    code: "VIP",
    label: "Accès VIP",
    description: "Accès gratuit — famille & partenaires",
    reduction: 100,
    type: "pct",
    icone: "⭐",
    usage_max: 20,
  },
  {
    ...
    code: "COMBO100",
    label: "Promo Combo",
    description: "100F de réduction sur CV + Lettre",
    reduction: 100,
    type: "fixe",
    icone: "📦",
    usage_max: 200,
